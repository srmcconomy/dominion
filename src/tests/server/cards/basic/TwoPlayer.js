...
export default () => {
  ...
  test('Have proper numbers in supplies', async () => {
    ...
    expect(game.supplies.get('Copper').cards.length).toBe(46);
    ...
    expect(game.supplies.get('Estate').cards.length).toBe(8);
    expect(game.supplies.get('Duchy').cards.length).toBe(8);
    expect(game.supplies.get('Province').cards.length).toBe(8);
    expect(game.supplies.get('Colony').cards.length).toBe(8);

    expect(game.supplies.get('Curse').cards.length).toBe(10);
