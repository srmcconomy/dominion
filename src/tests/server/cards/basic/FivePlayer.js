...
export default () => {
  ...
  test('Have proper numbers in supplies', async () => {
    ...
    expect(game.supplies.get('Copper').cards.length).toBe(25);
    ...
    expect(game.supplies.get('Province').cards.length).toBe(15);
    expect(game.supplies.get('Colony').cards.length).toBe(12);

    expect(game.supplies.get('Curse').cards.length).toBe(40);

    expect(game.supplies.get('Ruins').cards.length).toBe(40);
  });
};
